# fubon-html-scraper Specification

## Purpose

Defines the HTML scraper for Fubon ETFs 00982D (富邦動態入息) and 00983D (富邦複合收益), parsing the holdings table from the Fubon Asset Management product page using BeautifulSoup. Holdings are located by finding the "持股明細" heading and reading the subsequent `<tbody>` rows.
