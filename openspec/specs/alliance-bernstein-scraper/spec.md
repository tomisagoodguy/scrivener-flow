# alliance-bernstein-scraper Specification

## Purpose

Defines the scraper for AllianceBernstein ETF 00984D (聯博全球非投等投資等級) holdings, fetching constituent data from the official AllianceBernstein REST API. Because this ETF holds non-Taiwan bonds, `code` values may be ISIN strings rather than 4-digit TW stock codes.
