# etf-overlap-stock-table Specification

## Purpose

TBD - created by archiving change 'etf-overlap-table-view'. Update Purpose after archive.
...
<!-- @trace
source: etf-overlap-table-view
updated: 2026-08-21
code:
  - src/components/features/investment/EtfComparePanelUtils.ts
  - src/components/features/investment/EtfCompareViewTabs.tsx
  - src/app/investment/page.tsx
  - src/components/features/investment/EtfOverlapStockTable.tsx
tests:
  - src/components/features/investment/__tests__/EtfComparePanelUtils.test.ts
-->
