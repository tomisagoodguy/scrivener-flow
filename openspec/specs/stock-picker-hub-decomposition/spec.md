# Spec: StockPickerHub Decomposition

## Purpose

Define the structural constraints for decomposing the monolithic `StockPickerHub.tsx` component into a set of focused sub-components, a dedicated hook, and a shared types file. The goal is to enforce the 150-line component size rule, eliminate inline business logic from the component layer, and establish clear prop-passing boundaries between all pieces.
...
<!-- @trace
source: refactor-stock-picker-hub
updated: 2026-05-07
code:
