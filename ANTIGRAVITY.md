...
- [2026-01-24]: 已整合 `everything-claude-code` 全球頂級配置精華。新增 `learned-from-everything-claude-code` 技能與 `verification-loop` 工作流。強化了對於 Planning, Architecture 與 Security 的自動化檢查。
