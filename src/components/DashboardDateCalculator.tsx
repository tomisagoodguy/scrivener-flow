...
export default function DashboardDateCalculator() {
    ...
    if (result && contractDate) {
        ...
        milestones = [
            {
                date: parseISO(contractDate),
                label: '簽約',
                color: 'text-blue-600',
                bg: 'bg-blue-500 shadow-blue-200 shadow-sm',
            },
            {
                date: parseISO(result.sign_diff_date),
                label: '補差',
                color: 'text-indigo-600',
                bg: 'bg-indigo-500 shadow-indigo-200 shadow-sm',
            },
            {
                date: parseISO(result.seal_date),
                label: '用印',
                color: 'text-purple-600',
                bg: 'bg-purple-500 shadow-purple-200 shadow-sm',
            },
            {
                date: parseISO(result.tax_payment_date),
                label: '完稅',
                color: 'text-pink-600',
                bg: 'bg-pink-500 shadow-pink-200 shadow-sm',
            },
            {
                date: parseISO(result.handover_date),
                label: '交屋',
                color: 'text-emerald-600',
                bg: 'bg-emerald-500 shadow-emerald-200 shadow-sm',
            },
        ];
    }
