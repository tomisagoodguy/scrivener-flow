                        ...
                        >
                            ...
                            >
                                <div className="flex items-baseline gap-2">
                                    <span
                                        className={`text-2xl font-black ${isToday ? 'text-blue-600' : 'text-slate-700'}`}
                                    >
                                        {format(day, 'd')}
                                    </span>
                                    <span
                                        className={`text-xs font-bold uppercase ${isToday ? 'text-blue-500' : 'text-slate-400'}`}
                                    >
                                ...
                                <span className="text-xs font-medium text-slate-400">{dayTasks.length} 事項</span>
                            </div>
                                        ...
                                        >
                                            <div className="flex items-start gap-2">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div
                                                        className={`font-medium line-clamp-2 ${task.isCompleted ? 'line-through text-slate-400' : 'text-slate-700'}`}
                                                    >
                                                        {task.title}
                                                    </div>
