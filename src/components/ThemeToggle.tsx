...
export default function ThemeToggle() {
    ...
    return (
        ...
        >
            {theme === 'light' ? (
                <svg
                    className="w-5 h-5 text-amber-500 fill-amber-500 group-hover:rotate-12 transition-transform"
                    viewBox="0 0 24 24"
                >
                    <path
                ...
                <svg
                    className="w-5 h-5 text-blue-400 fill-blue-400 group-hover:-rotate-12 transition-transform"
                    viewBox="0 0 24 24"
                >
                    <path
