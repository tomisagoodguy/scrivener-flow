...
export default async function SectorsPage() {
    const [sectorData, icData, treemapData, adlData] = await Promise.all([
        getSectorStrength(),
    ...
    return (
        <div>
            ...
            <SectorDashboard data={sectorData} icData={icData} etfActivity={etfActivity} treemapData={treemapData} adlData={adlData} />
        </div>
    );
}
