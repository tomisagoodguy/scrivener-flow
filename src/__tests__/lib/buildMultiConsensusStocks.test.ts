...
describe('buildMultiConsensusStocks', () => {
            ...
            strategies: [
                {
                    ...
                    stocks: [
                        { stock_id: '3055', score: 1, movement: 'adding', name: '股票A', industry: '半導體', etfHolders: ['00981A'] },
                        { stock_id: '2464', score: 1, movement: 'holding', name: '股票B', industry: '電子', etfHolders: [] },
                    ],
                },
                {
                    id: 'low_vol_alpha',
                    ...
                    stocks: [
                        { stock_id: '3055', score: 1, movement: 'adding', name: '股票A', industry: '半導體', etfHolders: ['00981A'] },
                        { stock_id: '4127', score: 1, movement: 'none', name: '股票C', industry: '生技', etfHolders: [] },
                    ],
                },
                {
                    id: 'trend_template',
    ...
    it('filters out stocks appearing in only one strategy', () => {
        const result: StrategySignalsResult = {
            date: '2025-01-01',
            strategies: [
                { id: 'a', description: '', stocks: [{ stock_id: '1111', score: 1, movement: 'none' }] },
                { id: 'b', description: '', stocks: [{ stock_id: '2222', score: 1, movement: 'none' }] },
            ],
        };
            ...
            strategies: [
                {
                    id: 'a',
                    description: '',
                    stocks: [{ stock_id: '3055', score: 1, movement: 'adding', name: 'FirstName', industry: 'FirstIndustry', etfHolders: ['00981A'] }],
                },
                {
                    id: 'b',
                    description: '',
                    stocks: [{ stock_id: '3055', score: 1, movement: 'adding', name: 'SecondName', industry: 'SecondIndustry', etfHolders: ['00980A'] }],
                },
            ],
        };
        const entries = buildMultiConsensusStocks(result);
